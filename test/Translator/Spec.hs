...
spec = do
    ...
    describe "expressions" $ do
        it "translates expression into javascript" $ do
            ...
            translate (ExpPatternMatchCall (Identifier "x") (Type $ Identifier "funType") [PatternMatchExpression (Identifier "name") [] (ExpString "xyz"), PatternMatchExpression (Identifier "other") [] (ExpString "abc")]) typeEnv `shouldBe` "match x { name: \"xyz\" other: \"abc\"}"
    ...
    describe "Top Level Definitions" $ do
        it "translates a Top Level Definition into javascript" $ do
            ...
            translate (Func (FuncDefUnary (Identifier "funk") (Identifier "a") (Type $ Identifier "string") (ExpVariable $ Identifier "a") (Type $ Identifier "string"))) typeEnv `shouldBe` "function funk(a) { return a }"
            translate (Func (FuncDefNullary (Identifier "funk") (ExpVariable $ Identifier "a") (Type $ Identifier "string"))) typeEnv `shouldBe` "function funk() { return a }"
